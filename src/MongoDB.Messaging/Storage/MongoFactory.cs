...
namespace MongoDB.Messaging.Storage
{
    ...
    public static class MongoFactory
    {
        ...
        /// <exception cref="System.Configuration.ConfigurationErrorsException">No connection string could be found in the application configuration file.</exception>
        ...
        public static MongoUrl GetMongoUrl(string connectionName)
        {
            ...
            if (settings == null)
                throw new System.Configuration.ConfigurationErrorsException($"No connection string named '{connectionName}' could be found in the application configuration file.");

            string connectionString = settings.ConnectionString;
            if (string.IsNullOrEmpty(connectionString))
                throw new System.Configuration.ConfigurationErrorsException($"The connection string '{connectionName}' in the application's configuration file does not contain the required connectionString attribute.");
